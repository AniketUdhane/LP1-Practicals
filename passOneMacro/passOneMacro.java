...
try 
{ 
BufferedReader inp = new BufferedReader(new FileReader("D:\\LANGUAGES\\JAVA\\lpPractical\\src\\lp1_pass1_macro\\input")); 
File op = new File("D:\\LANGUAGES\\JAVA\\lpPractical\\src\\lp1_pass1_macro\\pass1_output"); 
if (!op.exists()) 
op.createNewFile(); 
